...
import { IonContent, IonHeader, IonTitle, IonToolbar, ModalController, IonList, IonItem, IonLabel, IonButton,IonItemOption,IonItemOptions,IonItemSliding,IonFab, IonFabButton } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonList, IonItem, IonLabel, IonButton,IonItemOption,IonItemOptions,IonItemSliding,IonFab, IonFabButton]
})
